...
window.addEventListener('resize', () => {
    // Se asume que currentPage y datos actuales están en variables globales
    if (typeof currentPage !== 'undefined' && typeof productos !== 'undefined') {
        actualizarPaginacion(currentPage, productos);
    }
});
...
function mostrarModalPedidoConfirmado(pedidoId, email) {
    ...
    overlay.innerHTML = `
        <div class="modal-content" style="max-width:350px;position:relative;">
            <h2 style='color:#4CAF50;'>¡Pedido realizado correctamente!</h2>
            <p>Se envió una notificación a tu casilla de email para que puedas ver o editar el pedido.</p>
    ...
    // Cerrar modal al hacer click fuera del contenido y refrescar la página
